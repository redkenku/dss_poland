...
| **PRE-10 — The Marshal delays the oath** | **P/E** | Hołownia or another Marshal withholds the National Assembly after the Supreme Court's validity ruling and claims temporary powers under a disputed reading of Article 131. | A short acting claim can occur, with court confrontation, foreign isolation, mass protest, possible removal and coalition rupture. It cannot become the Marshal's term or reverse the winner; only a Supreme Court invalidity judgment can trigger a new election. |
...
| **PIS-13 — Duda's Prawica reunification project** | **P** | Between November 2026 and September 2027, a former-president Duda who has completed his third act may call a seeded founding congress when the eligible right is highly fragmented and PiS is wholly outside government. PiS, Rozwój+, intact Konfederacja or its non-KKP successors, opposition PSL, Tak! Dla Rozwoju, P0, Kukiz'15, surviving Solidarna/Porozumienie/Republikanie/OdNowa organisations and only an independent Sikorski-led KO splinter vote separately; Korona/KKP is never invited. | Prawica forms only if PiS and two other units score at least 50. It is one 8% electoral coalition and parliamentary club under leader and PM nominee Andrzej Duda, while founders retain legal identity and component seats. A failed congress changes no affiliation or branding; a success gives every founder Prawica branding and supersedes ZP, Third Way, KP and common-centre assignments. |
